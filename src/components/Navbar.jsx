      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden lg:flex lg:items-center lg:gap-6">
            ...
            <NavLink to="/createGroup" className={navLinkClass}>Create Group</NavLink>
            <NavLink to="/myGroups" className={navLinkClass}>My Groups</NavLink>
            {/* ✅ New link — only show when logged in */}
            {user && (
              <NavLink to="/myJoinedGroups" className={navLinkClass}>
                My Joined Groups
              </NavLink>
            )}
          </div>
      ...
      {menuOpen && (
        <>
          ...
          >
            ...
            {/* ✅ New link — only show when logged in */}
            {user && (
              <NavLink to="/myJoinedGroups" onClick={() => setMenuOpen(false)} className={mobileLinkClass}>
                🎯 My Joined Groups
              </NavLink>
            )}
