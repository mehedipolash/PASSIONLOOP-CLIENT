...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#E6EEC9] shadow-md px-4 py-3 relative z-50">
      ...
      {/* Mobile dropdown — outside the flex row, full width */}
      {menuOpen && (
        <div className="lg:hidden absolute right-4 top-full mt-2 flex flex-col bg-base-100 shadow-xl rounded-xl p-4 w-52 z-50 text-accent font-medium gap-3 border border-base-300">
          <NavLink to="/" onClick={() => setMenuOpen(false)} className={navLinkClass}>Home</NavLink>
          <NavLink to="/allGroups" onClick={() => setMenuOpen(false)} className={navLinkClass}>All Groups</NavLink>
          <NavLink to="/createGroup" onClick={() => setMenuOpen(false)} className={navLinkClass}>Create Group</NavLink>
          <NavLink to="/myGroups" onClick={() => setMenuOpen(false)} className={navLinkClass}>My Groups</NavLink>
          ...
          {user ? (
            ...
            <div className="flex flex-col gap-2">
              <Link to="/auth/signin" onClick={() => setMenuOpen(false)} className="btn btn-primary btn-sm w-full">Login</Link>
              <Link to="/auth/signup" onClick={() => setMenuOpen(false)} className="btn btn-outline btn-primary btn-sm w-full">Register</Link>
            </div>
          )}
        </div>
      )}
