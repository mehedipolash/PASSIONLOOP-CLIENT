...
//               You haven't created any hobby groups. Start one and build your community!
//             </p>
...
//                       >
//                         {/* # */}
//                         <td className="px-5 py-3 text-base-content/40 font-medium">
//                           {index + 1}
//                         </td>
...
//                           <p className="text-xs text-base-content/40 line-clamp-1 max-w-[180px] mt-0.5">
//                             {group.description}
//                           </p>
//                         </td>
...
//                         {/* Max Members */}
//                         <td className="px-5 py-3 text-center font-semibold text-base-content">
//                           {group.maxMembers}
//                         </td>
...
//                           {isExpired ? (
//                             <span className="inline-block px-2.5 py-1 rounded-full text-xs font-semibold bg-error/10 text-error border border-error/20">
//                               Expired
//                             </span>
//                           ) : (
//                             <span className="inline-block px-2.5 py-1 rounded-full text-xs font-semibold bg-success/10 text-success border border-success/20">
//                               Active
//                             </span>
//                           )}
//                         </td>
